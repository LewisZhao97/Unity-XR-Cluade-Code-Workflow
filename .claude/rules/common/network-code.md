...
- Server is AUTHORITATIVE for all critical state — never trust the client
...
- XR: Synchronize tracked poses efficiently — compress quaternions, delta-encode positions
